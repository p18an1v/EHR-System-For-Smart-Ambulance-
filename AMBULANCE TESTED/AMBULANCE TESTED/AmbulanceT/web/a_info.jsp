...
<html lang="en">
    <head>
        ...
        <!--// css -->
        <!-- font-awesome icons -->
        <link href="../../../../../Continious from nikita/nikita/nikita/SmartCard/web/css/bootstrap.css" rel="stylesheet" type="text/css"/>
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="c_register.jsp">Register</a></li>
                                <li><a href="a_info.jsp" class="active">Accident_Info</a></li>
                            </ul>	
                            <div class="clearfix"> </div>
                        </div>
                    </nav>		
        ...
        <div id="blog" class="blog">
            <div class="container">  
                <center>
                  ...
                  <%--  <label name="link"><a href="JavaScript:newPopup('http://localhost:8081/AmbulanceT/opendevice.jsp');" size=1 tabIndex=18 >Click Here</a></label> --%>

                    <form action="Loginall1" method="post" >
                        <h1>Search Patient</h1>

                        <input type="text" name="ambulance" placeholder="Ambulance Id" required="required"><br>
                        <%-- <input type="file" name="imgpath" accept="image/gif, image/jpeg, image/png" required="required">--%>
                        <input type="text" name="location" placeholder="location coordinates(,)" required="required"><br>
                        <%--<input type="text" name="Confmpass" placeholder="ENTER THE USER CONFIRM-PASSWORD" required="required"> --%><br>
                        &nbsp; &nbsp;<input type="submit" value="Find Patient">&nbsp;&nbsp;<input type="reset" value="RESET">
                    </form>
                </center>
            </div>

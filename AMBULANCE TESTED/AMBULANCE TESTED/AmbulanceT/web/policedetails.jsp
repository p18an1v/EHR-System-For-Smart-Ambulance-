...
<html lang="en">
    <head>
        <title>Police-Records Show</title>
    ...
    <body>
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                <li class="first-list"><a class="first-list" href="adminmenu.jsp">Main_Menu</a></li>
                                <li><a href="policedetails.jsp" class="active" class="first-list">View Records</a></li>
                                <li><a href="police.jsp" class="first-list">Add P_Station</a></li>
        ...
        <%
            ...
            String sql = "select * from police_hospital where status='0'";
            ResultSet rs = db.Select(sql);
            String name = "", mobile = "", gender = "", address = "", head = "";
            int id = 0;
        %>

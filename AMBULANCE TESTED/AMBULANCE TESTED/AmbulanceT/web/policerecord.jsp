                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="policedetails.jsp" class="first-list">View Records</a></li>
                                <li><a href="police.jsp" class="first-list">Add Police Station</a></li>

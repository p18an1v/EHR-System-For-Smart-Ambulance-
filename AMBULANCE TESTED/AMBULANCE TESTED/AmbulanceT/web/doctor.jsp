    ...
    <body>
                    ...
                    <nav class="navbar navbar-default">
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="ddetails.jsp" class="first-list">View Records</a></li>
                                <li><a href="doctor.jsp" class="active" class="first-list">Add Hospitals</a></li>
        ...
        <script>
            function validation() {
                ...
                var hn = document.record.hn.value;
                var spec = document.record.spec.value;
                ...
                if (name == 0) {
                    ...
                    document.record.hn.focus();
                    return false;
                } else if (spec == 0) {
                    alert("Enter Specialist");
                    document.record.spec.focus();
                    return false;
                } else if (address == 0) {
        ...
        <fieldset>  
            <div id="blog" class="blog">
                <div class="container">  
                    ...
                    <form action="doctor" name="record" style="background: lightblue;position: relative;" method="post" onsubmit="return validation()"> 
                        <center>
                            <table>
                                <tr>
                                    <td>Doctor Name :</td>
                                ...
                                <tr>
                                    <td>Contact No :</td>
                                    <td><input type="text" name="mobile" id="mobile" pattern="[7-9]{1}[0-9]{9}" title="Phone number with 7-9 and remaing 9 digit with 0-9"></td>
                                </tr>
                                ...
                                <tr>
                                    <td>Coordinates :</td>
                                    <td><input type="text" name="coordinates" id="coordinates" placeholder="Seperated with Comma(,)"></td>
                                </tr>
                            </table>
                        </center>
